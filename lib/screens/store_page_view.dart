...
#ReadThatAgain''', backgroundColor: Colors.red),
  ...
  StoryView(
      {List<StoryItem>? storyItems, controller, bool? inline, bool? repeat}) {}
}

mixin StoryItem {
  static text({String? title, MaterialColor? backgroundColor}) {}

  static pageImage({String? url, controller, BoxFit? imageFit}) {}
}
